...
<title>附录B：游戏 - 在 openSUSE 上玩游戏</title>
...
<div class="heading1">附录B：游戏</div>

没有多少主流游戏可以原生地运行在GNU/Linux上，但还是有大量的游戏选择——至少对于普通玩家。
<br /><br />

<center><img src="images/pics/spil.jpg" alt="spil" class="pic" /></center>


<div class="heading2">B.1 原生的GNU/Linux游戏</div><br />
<div class="heading3">B.1.1 openSUSE Build Service 游戏软件源</div> 
一些游戏包含在 openSUSE 官方源里，但openSUSE Build Service的 Games 源包含更多的游戏。
 您可以简单地通过社区软件源列表添加这个游戏软件源，添加方法如
  <a href="repositories.php">软件源</a> 章节所述。<br /><br />

或者使用命令行添加游戏源：
<div class="clroot">zypper addrepo -f http://download.opensuse.org/repositories/games/openSUSE_Leap_15.4/ games</div><br />

<div class="heading3">B.1.2 Steam 游戏平台和商店</div>
Steam游戏平台已经发布Linux版本，并已经在Linux启用如
《反恐精英》、《反恐精英 起源》、《半条命》、《军团要塞2》、《反恐精英 零点行动》等多款游戏。
售价基本上是10到50美元。<br />
<b>Dota 2已经登陆Linux！安装Steam平台，然后在商店中找到Dota 2装上即可。</b>

<br />
官网：
<a href="http://store.steampowered.com/browse/linux/" target="_blank">http://store.steampowered.com/browse/linux/</a><br />
安装包：
<a href="http://software.opensuse.org/package/steam"  target="_blank">
...
Desura 发行服务为玩家提供到非免费单机游戏的便捷访问：<br />
<a href="http://www.desura.com" target="_blank">http://www.desura.com</a><br /><br />

<div class="heading3">B.1.4 其他 GNU/Linux 游戏资源</div>
Linux Game Publishing（Linux游戏发布站）购买主题游戏并将它们移植到
GNU/Linux中，请看：<br />
...
国内所有网页游戏只要按第14章安装Flash插件和Java插件，均可正常游玩:<br />
<a href="http://web.sanguosha.com/" target="_blank">
三国杀
</a><br />

<a href="http://web.4399.com/" target="_blank">
4399网页游戏
</a><br />
...
<div class="heading2">B.2 运行微软Windows游戏</div>

一些GNU/Linux可用的软件允许您在GNU/Linux上运行为微软Windows开发的
游戏——易用性和成功率可能会有所不同——然而，越受欢迎的游戏，
越有可能被支持。
<br /><br />


<div class="heading3">B.2.1 Wine（运行Windows程序的工具）</div>

Wine（Wine Is Not an Emulator，Wine不是个模拟器）是第一选择，
它是开源软件，可以通过软件管理工具（package manager）来安装。
可查看Wine应用程序数据库，获取运行个别游戏的信息：
<br />
...
<div class="heading3">B.2.2 PlayOnLinux（基于Wine的跨平台游戏工具）</div>
<a href="http://www.playonlinux.com/" target="_blank">PlayOnLinux</a>
是基于Wine的，可以让您轻松安装和使用（一些）微软Windows游戏。您可以在之前提到的游戏软件源中找到PlayOnLinux的安装包。
<br /><br />

<div class="heading3">B.2.3 CrossOver Games（基于Wine的跨平台游戏工具）</div>
...
<div class="heading2">B.3 模拟器（Emulators，运行经典小游戏）</div>

存在许多模拟器，使在GNU/Linux上运行其他平台的很多老的经典游戏成为可能。
如：
<br />

<ul>
  <li>Amiga (UAE，上世纪80年代的机子，被Commodore收购)</li>
  <li>Arcade (MAME，街机游戏)</li>
  <li>Atari (Stella, Steem，雅达利)</li>
  <li>Commodore 64/128 (VICE，上世纪的PC机)</li>
  <li>MS DOS (DOSBox, DOSEMU，DOS游戏)</li>
  <li>Nintendo (infones, bsnes, nestopia，任天堂电脑游戏)</li>
  <li>Play Station (pcsx, pcsx2，索尼PS2游戏机等)</li>
