...
<div class="os2">13.2 手动安装编解码包</div>
如果您喜欢的话，您可以手动安装这些包。
<br /><br />

首先使用Yast软件源工具添加下面的软件源： 
<br />
...
<li><b>gstreamer-plugins-libav</b>（这四个是GStreamer多媒体播放支持）</li>
...
<div class="os2">13.3 终端命令行安装编解码器</div>
