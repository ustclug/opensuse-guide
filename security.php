...
<div class="heading1">7. 安全设置</div>
openSUSE 和其他的 GNU/Linux 都是相当安全的，不过面对的是深不可测的互联网，一些必要的安全措施还是必要的。<br /><br />

<div class="heading2">7.1 Root 用户（拥有管理员权限）</div>
...
<div class="heading3">7.1.1 文件管理器（超级用户模式）</div>

当您要用图形界面处理需要管理员权限的系统文件（修改/home/目录之外的东西基本都要）时，您可以启动超级用户
模式Dolphin文件管理器。

<div class="path">开始菜单 => 系统 => File Manager - Super User Mode（文件管理器-超级用户模式）</div><br />
...
<div class="heading3">7.1.2 在终端中切换为root用户</div>
...
<div class="heading2">7.2 安全更新</div>
...
<div class="heading3">7.2.1 在终端中安装更新</div>
