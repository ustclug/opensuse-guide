...
<div class="os2">E.1 源代码 vs. 二进制机器码</div>
...
<div class="os2">E.2 Richard Stallman, GNU 和自由软件</div>
...
<div class="os3">E.2.1 GNU GPL, Copyleft（著佐权）和其他自由软件许可证</div>
...
<div class="os2">E.3 Linux 和 Linus Torvalds</div>
...
<div class="os2">E.5 openSUSE的历史</div>

SUSE在德国于1992年9月2日成立，以Gesellschaft f&uuml;r Software- und Systementwicklung mbH (S.u.S.E. GmbH)命名，意为：“软件和系统开发公司”。
...
<tbody>
	<tr>
		...
		<td style="width: 25%"><div style="text-align: center;"><img style="width: 150px; height: 150px;" alt="geeko" src="images/pics/opensuse.jpg" /></div></td>
      	...
      	<tr>
		<td class="billedtekst"> GNU项目吉祥物</td>
		<td class="billedtekst">Linux官方吉祥物-企鹅Tux</td>
		<td class="billedtekst">KDE吉祥物-恐龙Konqui</td>
		<td class="billedtekst">SUSE吉祥物-变色龙Geeko</td>
	</tr>
</tbody>
</table><br /><br />


<div class="os2">E.6 GNU/Linux生态系统</div><br />

<div class="os3">E.6.1 发行版</div>
...
<div class="os3">E.6.2 谁开发了自由软件和为什么要开发？</div>
...
<div class="os3">E.6.3 谁在使用GNU/Linux ？</div>
