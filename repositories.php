...
<ul>
    ...
    <li>
        <b><a href="http://download.opensuse.org/repositories/home:/opensuse_zh/openSUSE_Leap_15.1/" target="_blank">
...
<!--
    ...
    <li>
        <a href="http://download.opensuse.org/repositories/home:/hillwood/openSUSE_Leap_15.1/" target="_blank">
        http://download.opensuse.org/repositories/home:/hillwood/openSUSE_Leap_15.1/
        </a>
    </li>
--> 
<!--
    <li>
        <a href="http://download.opensuse.org/repositories/home:/stecue/openSUSE_15.1/" target="_blank">
        http://download.opensuse.org/repositories/home:/stecue/openSUSE_15.1/
        </a>
    </li>
-->
    ...
    <li>
        <a href="http://mirrors.hust.edu.cn/packman/suse/openSUSE_Leap_15.1/" target="_blank">
        http://mirrors.hust.edu.cn/packman/suse/openSUSE_Leap_15.1/
        </a>（华中科技大学Packman源）
    </li>
    <li>
